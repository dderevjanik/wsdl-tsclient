    ...
    for (var _i = 0, _a = definition.properties; _i < _a.length; _i++) {
        ...
        if (options.modelPropertyNaming) {
            switch (options.modelPropertyNaming) {
                case _1.ModelPropertyNaming.camelCase:
                    prop.name = camelcase_1.default(prop.name);
                    break;
                case _1.ModelPropertyNaming.PascalCase:
                    prop.name = camelcase_1.default(prop.name, { pascalCase: true });
                    break;
            }
        }
        if (prop.kind === "PRIMITIVE") {
            ...
            if (!generated.includes(prop.ref)) {
                ...
                generateDefinitionFile(project, prop.ref, defDir, __spreadArray(__spreadArray([], stack), [prop.ref.name]), generated, options);
            }
                ...
                for (_b = 0, _c = parsedWsdl.ports; _b < _c.length; _b++) {
                    ...
                    for (_d = 0, _e = port.methods; _d < _e.length; _d++) {
                        ...
                        portFileMethods.push({
                            ...
                            parameters: [
                                {
                                    name: camelcase_1.default(method.paramName),
